...
#Prueba 5
def test_create_user_with_spaces_in_first_name_get_error_response():
    negative_assert_symbol("A Aaa")

#Prueba 6
def test_create_user_with_special_characters_in_first_name_get_error_response():
    negative_assert_symbol("\"№%@\",")

#Prueba 7
def test_create_user_with_numbers_in_first_name_get_error_response():
